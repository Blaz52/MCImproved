...
public class ModOreGeneration {
    public static void generateOres(final BiomeLoadingEvent event) {
        spawnOreInAllBiomes(OreType.CHROMIUM_ORE, event, LevelStem.OVERWORLD.toString());
        spawnOreInAllBiomes(OreType.END_ORE, event, LevelStem.END.toString());

        spawnOreInAllBiomes(OreType.SULFUR_ORE, event, LevelStem.OVERWORLD.toString());
